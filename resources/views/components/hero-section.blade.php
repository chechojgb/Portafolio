<section class="hero min-h-screen flex items-center relative px-4 sm:px-6 lg:px-8 z-10 pb-10 ">
    <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-12 lg:py-0">
        ...
        <div class="w-full lg:w-1/2 mb-12 lg:mb-0 relative">
            ...
            <div class="flex flex-col sm:flex-row gap-6 animate-fadeInUp">
                <a href="{{ asset('cv_sergio_ortiz.pdf') }}" download class="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-teal-400 p-0.5 rounded-xl hover:scale-105 transition">
                ...
                <a href="https://github.com/chechojgb" class="group relative inline-flex items-center justify-center gap-3 p-0.5 rounded-xl bg-gradient-to-r from-gray-800 to-gray-700 hover:scale-105 transition">
...
passion: 'Construir algo innovador (rm -rf /)'
        ...
        <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce flex flex-col items-center gap-2 ">
            <span class="text-gray-400 text-sm flex items-center gap-2">
                <i class="fas fa-mouse text-blue-400"></i> Sobre mí
            </span>
